...
import { priceRepairInterior } from "../../Utils";
import ArrowRight from "../../components/svg/ArrowRight";
import { ScrollView } from "react-native-gesture-handler";
import { typeInterior } from "../data";
import FormServiceRepairInterior from "./FormServiceRepairInterior";
      ...
      >
        ...
        >
          <View style={[MainStyles.flexRowSpaceBetween, { backgroundColor: 'transparent' }]}>
            <Text style={styles.btnTitle}>{priceRepairInterior(formData, price, time)}</Text>
...
export default ServiceRepairInteriorScreen;