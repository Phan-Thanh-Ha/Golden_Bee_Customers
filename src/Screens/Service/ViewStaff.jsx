...
import { shallowEqual, useFilteredOrderById } from '../../Utils/OrderMiddleware';
        ...
        >
          ...
          }
          {
            clientOrder?.StatusOrder === 2 && (
              <>
                <Text>
                  {clientOrder?.StaffName} {(clientOrder?.StatusOrder === 2 && customRound(timeOut.duration) > 0) && ` sẽ đến trong ${customRound(timeOut.duration)} phút `}
                </Text>
