...
import { priceRepairAirConditioner } from "../../Utils";
import ArrowRight from "../../components/svg/ArrowRight";
import { ScrollView } from "react-native-gesture-handler";
import { typeAir } from "../data";
      ...
      >
        ...
        >
          <View style={[MainStyles.flexRowSpaceBetween, { backgroundColor: 'transparent' }]}>
            <Text style={styles.btnTitle}>{priceRepairAirConditioner(formData, price, time)}</Text>
...
export default ServiceRepairAirScreen;