...
import { dataOtherService1, dataOtherService2 } from '../data';

const validationSchema = Yup.object().shape({
  room: Yup.string().required('Vui lòng nhập số phòng'),
});

const FormServiceHouseClearning = ({ onSubmit, onChange, timeWorking }) => (
...
export default FormServiceHouseClearning;