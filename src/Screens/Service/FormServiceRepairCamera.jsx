...
import { otherServiceRepairAir, otherServiceRepairCamera, typeAir, typeCamera } from '../data';
...
const FormServiceRepairCamera = ({ onSubmit, onChange, timeWorking }) => (
...
export default FormServiceRepairCamera;